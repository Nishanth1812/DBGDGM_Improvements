...
The script writes `labels.csv` and `dataset_summary.json` into the output root. The prepared folder, or the zip created from it, can then be used with the existing Modal training flow.
